...
• <strong>核心策略</strong>：</li>
</ol>
<pre><code>• **热点数据预加载**：通过离线分析提前缓存高频访问数据。  
...
• <strong>容灾设计</strong>：</li>
</ol>
<pre><code>• **降级策略**：若Redis不可用，直接拒绝请求（非核心功能降级）。  
...
<pre><code>• TPS从1万提升至10万，数据库负载降低70%。  
...
<pre><code>• 服务可用性从80%提升至99.9%，峰值QPS支持100万。  
• 用户感知为“信息延迟”，但无服务崩溃。  
</code></pre>
<hr>
...
• <strong>高频考点</strong>：</li>
</ol>
<pre><code>• **缓存 vs 数据库**：何时用缓存？如何保证一致性？  
